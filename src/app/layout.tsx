...
export const metadata: Metadata = {
  title: "Sunil | Next Portfolio 2024",
  description:
    "Sunil is a frontend developer, likes to talk about JavaScript, ReactJS and NextJS.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-gray-50 relative  h-[5000px] text-gray-950`}
      >
